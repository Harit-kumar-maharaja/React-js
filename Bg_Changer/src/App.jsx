  ...
  return (
    ...
    <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2">
      <div className="flex flex-wrap justify-center gap-3 shadow-lg bg-black px-3 py-2 rounded-3xl">
        ...
        <button onClick={() => setcolor("Purple")} className="outline-none px-4 rounded-full text-black shadow-lg" style={{backgroundColor:"Purple"}}>Purple</button>
        <button onClick={() => setcolor("Lavender")} className="outline-none px-4 rounded-full text-black shadow-lg" style={{backgroundColor:"Lavender"}}>Lavender</button>
